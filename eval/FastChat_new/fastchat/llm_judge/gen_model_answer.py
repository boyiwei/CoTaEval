        ...
        for i in range(num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                if 'mem_free' in args.intervention:
                    if args.bf_type == 'newsqa':
                        bloom_filter = 'newsqa_tokenized.36-36.bf'
                    elif args.bf_type == 'booksum':
                        bloom_filter = 'booksum_tokenized.36-36.bf'
