    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if self.generation_config.mem_free_new:
                next_tokens_scores, input_ids = logits_processor(input_ids, next_token_logits) # for new memfree method, update input_ids as well
            else:
